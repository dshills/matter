// Package errtype defines typed error categories and classifications for the
// agent framework. This package is dependency-free within the project so that
// any internal package can import it without creating cycles.
package errtype
